    ...
    <div class="dashboard-main-body">
        <div class="mb-24 d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-2">
                ...
                <?php endif; ?>
                <a href="./business-stationery-wizard.php?id=<?= $websiteId ?>&prod_id=<?= $productId ?>"><button type="button" class="btn btn-sm btn-edit-website">Wizard</button></a>
            </div>
        </div>
        ...
        <div class="row gy-4">
            ...
            <div class="col-lg-6">
                <div class="card h-100 p-0">
                    <div class="card-header border-bottom bg-base py-16 px-24">
                        <h6 class="text-lg fw-semibold mb-0">Design & Printing:</h6>
                    </div>
