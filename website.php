<?php include './partials/layouts/layoutTop.php'; ?>
    ...
    <body>
        ...
        <div class="search-card bg-base">
            ...
            <a href="view-website.php" class="add-btn">+ Add New Website</a>
        </div>
        ...
        <!-- <div class="list-section" id="websiteList"> -->
            ...
            if ($status === 'approved') {
                ...
                <div class="list-item bg-base <?php echo $statusClass; ?>">
                    ...
                    <a href="website-det.php?website_id=<?php echo (int)$site['web_id']; ?>&product_id=<?php echo (int)$site['product_id']; ?>&type=<?php echo $site['type']; ?>" class="dashboard-btn">Manage</a>
