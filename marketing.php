<?php include './partials/layouts/layoutTop.php'; ?>
    ...
    <body>
        ...
        <div class="search-card bg-base">
            ...
            <input type="text" id="searchInput" placeholder="Search Marketing..." />
            </div>
            <a href="view-marketing.php" class="add-btn">+ Add New Marketing</a>
        </div>
        ...
        <!-- <div class="list-section" id="websiteList"> -->
            ...
            if ($status === 'approved') {
                ...
                <div class="list-item bg-base <?php echo $statusClass; ?>">
                    ...
                    <a href="marketing-det.php?website_id=<?php echo (int)$site['web_id']; ?>&product_id=<?php echo (int)$site['product_id']; ?>&type=<?php echo $site['type']; ?>" class="dashboard-btn">Manage</a>
