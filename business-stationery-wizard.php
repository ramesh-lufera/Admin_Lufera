...
<div class="dashboard-main-body">
    <div class="d-flex flex-wrap align-items-center gap-3 mb-24 justify-content-between">
        <div class="d-flex align-self-end">
            ...
            <h6 class="fw-semibold mb-0">Business Stationery Wizard</h6>
        </div>
...
<?php
    ...
    // ------------------------------------------------
    // Load existing JSON record if it exists
    // ------------------------------------------------
    $data = [];
    $recordExists = false;
    ...
    if ($result->num_rows > 0) {
        ...
        // Keep existing record information
...
<!-- ════════════════════════════════════════════════════════════ -->
<h5>Business Stationery Requirements</h5>
...
renderFieldExtended('address', $savedData, $user_role, 'Business Address', '', 'textarea');

renderFieldExtended('stationery_items', $savedData, $user_role, 'Required Stationery Items', '', 'textarea');
...
$('#exportPdfBtn').click(function() {
            ...
            const sections = [
                {
                    title: 'Business Stationery Requirements',
                    fields: [
                        ...
                        { label: 'Required Stationery Items', key: 'stationery_items' },
                        { label: 'Additional Requirements', key: 'additional_requirements' }
                    ]
                }
            ];

            let html = '<html><head><title>Business Stationery Wizard</title>';
            html += '<style>';
            ...
            html += '<h1>Business Stationery Wizard</h1>';
    ...
    document.querySelectorAll('.load-record').forEach(checkbox => {
        checkbox.addEventListener('change', function () {
            ...
            const fieldMap = {
                ...
                'stationery_items':         data.stationery_items?.value,
