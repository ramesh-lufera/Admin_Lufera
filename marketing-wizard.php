...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['inline_update'])) {
    ...
    // If a record exists, load its JSON.
    ...
    if (
        ...
        // Normal text / textarea / select / checkbox / radio
                                ...
                                <form action="" method="post" id="myForm" role="form" enctype="multipart/form-data">
                                    ...
                                    <!-- <h4 class="m-auto" style="width:max-content">Marketing</h4> -->
                                            <?php
                                                ...
                                                renderFieldExtended('facebook_id', $savedData, $user_role, 'Facebook ID', 'Facebook ID', 'text');
