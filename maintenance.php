            ...
            <div class="py-res-120">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        ...
                        <div class="mt-56 max-w-500-px text-start">
                            ...
                            <form action="#" class="mt-16 d-flex gap-16 flex-sm-row flex-column">
                                <input type="email" class="form-control text-start py-24 flex-grow-1" placeholder="info@luferatech.com" required>
                    ...
                    <div class="col-lg-6 d-lg-block d-none">
                        <img src="assets/images/coming-soon/maintenance-1.png" alt="">
                    </div>
                </div>
            </div>
        </div>
