...
<div class="dashboard-main-body">
    <div class="d-flex flex-wrap align-items-center gap-3 mb-24 justify-content-between">
        <div class="d-flex align-self-end">
            ...
            <h6 class="fw-semibold mb-0">Envelopes Wizard</h6>
        </div>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['inline_update'])) {
    ...
    /*
     * Find the exact JSON record belonging to:
     *   user_id + website_id + template
     *
     * This matches the normal SAVE logic below.
     */
    $jsonId = 0;
    $json_str = null;
    ...
    // Decode existing JSON if available
    $data = [];
     ...
     *
     * This is important when an admin edits a field before
     * the field has ever been saved into the JSON record.
     */
    ...
    /*
     * Every admin inline edit goes back to pending.
     */
...
<!-- ════════════════════════════════════════════════════════════ -->
<h5>Envelopes (DL Size) Requirements</h5>
...
renderFieldExtended('address', $savedData, $user_role, 'Company Address', '', 'textarea');

renderFieldExtended('envelope_color', $savedData, $user_role, 'Envelope Color', '', 'select', [
    'White',
    'Cream',
    'Brown',
    'Custom'
...
$('#exportPdfBtn').click(function() {
            ...
            const sections = [
                {
                    title: 'Envelopes (DL Size) Requirements',
                    fields: [
                        ...
                        { label: 'Envelope Color', key: 'envelope_color' },
            ...
            let html = '<html><head><title>Envelopes Wizard</title>';
            html += '<style>';
    ...
    document.querySelectorAll('.load-record').forEach(checkbox => {
        checkbox.addEventListener('change', function () {
            ...
            const fieldMap = {
                ...
                'envelope_color':           data.envelope_color?.value,
